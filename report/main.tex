...
\end{tabular}
\caption{\label{tab:perf}Performance table of THIN and EPYC architectures.}
\end{table}

\subsection{Using a fixed number of cores}

As mentioned above, in this section, we keep the number of cores fixed and 
we slowly increase the size of the matrices being multiplied from $m=2000$ 
to $m=20000$. 

\subsubsection{THIN Nodes}

THIN nodes have two sockets each of $12$ cores, for a total of $24$ cores per 
node. The cores are Intel(R) Xeon(R) Gold $6126$ CPU at $2.60$GHz, which are 
part of the Skylake microarchitecture.

Furthermore, we know that the peak performance of any machine is given by the 
equation: 
...
\begin{figure}[h]
\centering
\includegraphics[width=14cm, height=6cm]{./images/fixed_cores_thin_float_time.pdf}
\includegraphics[width=14cm, height=6cm]{./images/fixed_cores_thin_float_gflops.pdf}
\caption{\label{fig:fixed_cores_thin_float}}
\end{figure}

\begin{figure}[h]
\centering
\includegraphics[width=10cm, height=5cm]{./images/fixed_cores_thin_double_time.pdf}
\includegraphics[width=10cm, height=5cm]{./images/fixed_cores_thin_double_gflops.pdf}
\caption{\label{fig:fixed_cores_thin_double}.}
\end{figure}
...
\begin{figure}[h]
\centering
\includegraphics[width=10cm, height=5cm]{./images/fixed_cores_epyc_float_time.pdf}
\includegraphics[width=10cm, height=5cm]{./images/fixed_cores_epyc_float_gflops.pdf}
\caption{\label{fig:fixed_cores_epyc_float}.}
\end{figure}

\begin{figure}[h]
\centering
\includegraphics[width=10cm, height=5cm]{./images/fixed_cores_epyc_double_time.pdf}
\includegraphics[width=10cm, height=5cm]{./images/fixed_cores_epyc_double_gflops.pdf}
\caption{\label{fig:fixed_cores_epyc_double}.}
\end{figure}
