...
// =============================================================
//  utilities for managinf pbm files
//
//  * write_pgm_image
//  * read_pgm_image
//  * swap_image
...
void write_pbm_image(void *image, int evolution_type, int xsize, int ysize, const char *image_name)
/*
 * image        : a pointer to the memory region that contains the image
 * evolution_type   : either 0 or 1 for ordered or static
 ...
 */
{
  ...
  // - The Magic Number (see below the magic numbers) in the first line
  // - the image's width and height
  //
  // These can be separated by space or new line characters
  // It can also have a comment in between

  int color_depth = 1 + ( maxval > 255 );

  fprintf(image_file, "P4\n# generated by Andres Bermeo Marinelli\n%d %d\n", xsize, ysize);
