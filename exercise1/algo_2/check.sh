...
./algo2_conway_serial_pgm.out -r -f snark_loop_01.pgm -n 100 -s 100 -e 0
mv snapshot_00100 snapshot_00100.serial

./algo2_conway_omp_pgm.out -r -f snark_loop_01.pgm -n 100 -s 100 -e 0
mv snapshot_00100 snapshot_00100.omp

mpirun -np 2 algo2_conway_mpi_pgm.out -r -f snark_loop_01.pgm -n 100 -s 100 -e 0
mv snapshot_00100 snapshot_00100.mpi
...
./algo2_conway_serial_pgm.out -r -f gosper_glider_gun_01.pgm -n 400 -s 400 -e 0
mv snapshot_00400 snapshot_00400.serial

./algo2_conway_omp_pgm.out -r -f gosper_glider_gun_01.pgm -n 400 -s 400 -e 0
mv snapshot_00400 snapshot_00400.omp

mpirun -np 2 algo2_conway_mpi_pgm.out -r -f gosper_glider_gun_01.pgm -n 400 -s 400 -e 0
mv snapshot_00400 snapshot_00400.mpi
